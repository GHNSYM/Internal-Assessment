    ...
    <div class="marks">
        ...
        <form action="POST">
            <div class="row">
                ...
                <div class="col">
                    <input type="submit" name="submit" value="SAVE" class="btn-primary edit">
                </div>
            </div>
                                    ...
                                    while($row2=mysqli_fetch_assoc($res2))
                                    {
                                        ...
                                        ?>
                                            <tr>             
                                                ...
                                                <td><?php echo $sub;?></td>
                                                <td>
                                                    <input type="number" name="<?php echo $code;?>" value="<?php echo $sess;?>">
                                                </td>
                                                <td>
                                                    <input type="number" name="<?php echo $code;?>" value="<?php echo $assi;?>">
                                                </td>
                                                <td>
                                                    <input type="number" name="<?php echo $code;?>" value="<?php echo $atten;?>"> 
                                                </td>
